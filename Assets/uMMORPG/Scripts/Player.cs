...
[RequireComponent(typeof(Finesse))]
...
public partial class Player : Entity
{
    ...
    protected override void Start()
    {
        ...
        gameObject.GetComponent<DynamicCharacterAvatar>().LoadFromRecipeString(gameObject.GetComponent<DNA>().dna);

        //THIS IS HOW YOU SET CONTROL SCHEME FOR SKILLBAR
        gameObject.GetComponent<PlayerSkillbar>().slots[0].hotKey = KeyCode.Mouse0;
