...
public class TargetProjectileSkill : DamageSkill
{
    ...
    public override bool CheckTarget(Entity caster)
    {
        ...
        // If entity exists and we calculate distacne and how high cursor should be based on distance and cursor is x amount higher within threshold, set target to the entity
        // Else, instantiate a new faketarget prefab and set the target to that
